...
# @app.route('/item/<whattoadd>', methods=['POST'])
# def add_random_item(whattoadd):
#     # Adding new item based on the /"item here"
#     req_data = request.get_json()
#     print(req_data)
#     whattoadd = req_data['item']

#     # Add item to the list
#     res_data = helper.add_to_list(whattoadd)

#     # Return error if item not added
#     if res_data is None:
#         response = Response("{'error': 'Item not added - " + {whattoadd} + "'}", status=400 , mimetype='application/json')
#         return response
